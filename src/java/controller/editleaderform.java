...
@WebServlet("/EditLeaderForm")
public class editleaderform extends HttpServlet {
...
//            out.println("<div class='container'>");
            ...
            LeaderBean leader = LeaderDao.viewById(id);

//            out.print("<form action='EditLeader' method='post' style='width:300px'>");
...
//            out.println("</div>");
            ...
            request.getRequestDispatcher("editleaderform.jsp").include(request, response);
//            out.close();
//        }
